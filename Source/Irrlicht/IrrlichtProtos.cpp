...
void add_values_irr(LangInterpreter& vm)
{
    ...
    LM_ENUM_PROTOS(vm, (ETPS_17))

    LM_ENUM_PROTOS(vm, (EMF_WIREFRAME)(EMF_POINTCLOUD)(EMF_GOURAUD_SHADING)(EMF_LIGHTING)(EMF_ZBUFFER)(EMF_ZWRITE_ENABLE)
    ...
    LM_ENUM_PROTOS(vm, (ETS_VIEW)(ETS_WORLD)(ETS_PROJECTION)(ETS_TEXTURE_0)(ETS_TEXTURE_1)(ETS_TEXTURE_2)(ETS_TEXTURE_3))

    LM_ENUM_PROTOS(vm, (EVT_STANDARD)(EVT_2TCOORDS)(EVT_TANGENTS))

    LM_ENUM_PROTOS(vm, (EMT_SOLID)(EMT_SOLID_2_LAYER)(EMT_LIGHTMAP)(EMT_LIGHTMAP_ADD)(EMT_LIGHTMAP_M2)(EMT_LIGHTMAP_M4)(EMT_LIGHTMAP_LIGHTING)(EMT_LIGHTMAP_LIGHTING_M2)
    ...
    LM_ENUM_PROTOS(vm, (EHM_NEVER)(EHM_STATIC)(EHM_DYNAMIC)(EHM_STREAM) )
    ...
    LM_ENUM_PROTOS(vm, (EET_KEY_INPUT_EVENT)(EET_MOUSE_INPUT_EVENT)(EET_GUI_EVENT))
    ...
    LM_ENUM_PROTOS(vm, (EGET_BUTTON_CLICKED)(EGET_TREEVIEW_NODE_DESELECT)(EGET_TREEVIEW_NODE_SELECT)(EGET_TREEVIEW_NODE_EXPAND)(EGET_TREEVIEW_NODE_COLLAPS))
}
