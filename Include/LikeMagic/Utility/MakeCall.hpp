...
void call_void(T t, F f, std::tuple<boost::intrusive_ptr<Expression<ArgTypes>>...> args, IndexPack<Indices...>)
{
...
void call_static_void(F f, std::tuple<boost::intrusive_ptr<Expression<ArgTypes>>...> args, IndexPack<Indices...>)
{
...
template <typename F, typename... ArgTypes, int... Indices>
typename FuncPtrTraits<F>::R
call_static_nonvoid(F f, std::tuple<boost::intrusive_ptr<Expression<ArgTypes>>...> args, IndexPack<Indices...>)
{
