...
int main()
{
	...
	*/
	IAnimatedMesh* mesh = smgr->getMesh("/Users/dennisferron/code/irrlicht-1.8-unstable/media/sydney.md2");
	if (!mesh)
	{
		device->drop();
		return 1;
	...
	*/
	if (node)
	{
		...
		node->setMaterialTexture( 0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/sydney.bmp") );
	}
