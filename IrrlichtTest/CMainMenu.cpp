			...
			video::E_DRIVER_TYPE& outDriver)
{
	...
	if (MenuDevice->getFileSystem()->existFile("irrlicht.dat"))
		...
		MenuDevice->getFileSystem()->addFileArchive("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht.dat");
	...
	// load font
	gui::IGUIFont* font = guienv->getFont("/Users/dennisferron/code/irrlicht-1.8-unstable/media/fonthaettenschweiler.bmp");
	if (font)
	...
	scene::IAnimatedMesh* mesh = smgr->getMesh("/Users/dennisferron/code/irrlicht-1.8-unstable/media/faerie.md2");
	...
	if (modelNode)
	{
		...
		modelNode->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/faerie2.bmp"));
		...
		switch ( l->type )
		{
			...
			case LIGHT_RED:
				...
				if ( bill )
				{
					...
					bill->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/particlered.bmp"));
				}
	...
	guienv->addImage(driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlichtlogo3.png"),
		core::position2d<s32>(5,5));

	video::ITexture* irrlichtBack = driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/demoback.jpg");
