...
void CDemo::run()
{
	...
	if (device->getFileSystem()->existFile("irrlicht.dat"))
		...
		device->getFileSystem()->addFileArchive("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht.dat");
	if (device->getFileSystem()->existFile("map-20kdm2.pk3"))
		device->getFileSystem()->addFileArchive("map-20kdm2.pk3");
	else
		device->getFileSystem()->addFileArchive("/Users/dennisferron/code/irrlicht-1.8-unstable/media/map-20kdm2.pk3");
...
void CDemo::loadSceneData()
{
	...
	mesh = sm->getMesh("/Users/dennisferron/code/irrlicht-1.8-unstable/media/sydney.md2");
	if (mesh)
	{
		model1 = sm->addAnimatedMeshSceneNode(mesh);
		if (model1)
		{
			model1->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/spheremap.jpg"));
		...
		if (model2)
		{
			...
			model2->setMaterialTexture(0, device->getVideoDriver()->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/sydney.bmp"));
	...
	skyboxNode = sm->addSkyBoxSceneNode(
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_up.jpg"),
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_dn.jpg"),
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_lf.jpg"),
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_rt.jpg"),
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_ft.jpg"),
		driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlicht2_bk.jpg"));
	...
	for (s32 g=1; g<8; ++g)
	{
		core::stringc tmp("/Users/dennisferron/code/irrlicht-1.8-unstable/media/portal");
		tmp += g;
		tmp += ".bmp";
	...
	for (int r=0; r<2; ++r)
	{
		...
		bill->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/portal1.bmp"));
	...
	bill->setMaterialFlag(video::EMF_LIGHTING, false);
	bill->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/particlewhite.bmp"));
	bill->setMaterialType(video::EMT_TRANSPARENT_ADD_COLOR);
	...
	campFire->setMaterialTexture(0, driver->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/fireball.bmp"));
...
void CDemo::createLoadingScreen()
{
	...
	// irrlicht logo
	device->getGUIEnvironment()->addImage(device->getVideoDriver()->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/irrlichtlogo2.png"),
	...
	device->getGUIEnvironment()->getSkin()->setFont(
		device->getGUIEnvironment()->getFont("/Users/dennisferron/code/irrlicht-1.8-unstable/media/fonthaettenschweiler.bmp"));
...
void CDemo::shoot()
{
	...
	node->setMaterialTexture(0, device->getVideoDriver()->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/fireball.bmp"));
...
void CDemo::createParticleImpacts()
{
	...
	for (s32 i=0; i<(s32)Impacts.size(); ++i)
		if (now > Impacts[i].when)
		{
			...
			pas->setMaterialTexture(0, device->getVideoDriver()->getTexture("/Users/dennisferron/code/irrlicht-1.8-unstable/media/smoke.bmp"));
...
void CDemo::startIrrKlang()
{
	...
	irrklang::ISound* snd = irrKlang->play2D("/Users/dennisferron/code/irrlicht-1.8-unstable/media/IrrlichtTheme.ogg", true, false, true);
	if ( !snd )
	...
	ballSound = irrKlang->getSoundSource("/Users/dennisferron/code/irrlicht-1.8-unstable/media/ball.wav");
	impactSound = irrKlang->getSoundSource("/Users/dennisferron/code/irrlicht-1.8-unstable/media/impact.wav");
}
#endif
...
void CDemo::startSound()
{
	...
	stream = Mix_LoadMUS("/Users/dennisferron/code/irrlicht-1.8-unstable/media/IrrlichtTheme.ogg");
	if (stream)
		Mix_PlayMusic(stream, -1);

	ballSound = Mix_LoadWAV("/Users/dennisferron/code/irrlicht-1.8-unstable/media/ball.wav");
	impactSound = Mix_LoadWAV("/Users/dennisferron/code/irrlicht-1.8-unstable/media/impact.wav");
}
