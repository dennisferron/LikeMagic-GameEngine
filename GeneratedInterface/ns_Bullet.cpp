...
auto btSoftBody::ref_m_bounds(GameBindings::uint_expr arg0) -> MissingType /* C++ btVector3 []& */ 
{
    ::LM::ExprPtr args[] = { arg0.expr }; 
    return { ::LM::call(expr, "ref_m_bounds", args, 1) };
}
auto btSoftBody::set_m_bounds(GameBindings::uint_expr arg0, GameBindings::Bullet::btVector3 arg1) -> GameBindings::void_expr
{
    ::LM::ExprPtr args[] = { arg0.expr, arg1.expr }; 
...
auto btSoftBody::get_m_bounds(GameBindings::uint_expr arg0) -> MissingType /* C++ btVector3 [] */ 
{
    ::LM::ExprPtr args[] = { arg0.expr }; 
