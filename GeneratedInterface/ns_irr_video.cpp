...
auto SMaterial::ref_TextureLayer(MissingType /* C++ unsigned long long (end) */  arg0) -> MissingType /* C++ irr::video::SMaterialLayer []& */ 
{
    ::LM::ExprPtr args[] = { arg0.expr }; 
...
auto SMaterial::get_TextureLayer(MissingType /* C++ unsigned long long (end) */  arg0) -> MissingType /* C++ irr::video::SMaterialLayer [] */ 
{
    ::LM::ExprPtr args[] = { arg0.expr }; 
...
auto SMaterial::set_TextureLayer(MissingType /* C++ unsigned long long (end) */  arg0, GameBindings::irr::video::SMaterialLayer arg1) -> GameBindings::void_expr
{
    ::LM::ExprPtr args[] = { arg0.expr, arg1.expr }; 
