...
};struct SMaterial
{
    ...
    auto ref_TextureLayer(MissingType /* C++ unsigned long long (end) */ ) -> MissingType /* C++ irr::video::SMaterialLayer []& */ ;
    ...
    auto get_TextureLayer(MissingType /* C++ unsigned long long (end) */ ) -> MissingType /* C++ irr::video::SMaterialLayer [] */ ;
    ...
    auto set_TextureLayer(MissingType /* C++ unsigned long long (end) */ , GameBindings::irr::video::SMaterialLayer) -> GameBindings::void_expr;
    auto unsafe_ptr_cast() -> GameBindings::BottomPtr;
