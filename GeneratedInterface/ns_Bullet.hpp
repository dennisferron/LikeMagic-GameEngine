...
{
    ::LM::ExprPtr expr;
    auto ref_m_bounds(GameBindings::uint_expr) -> MissingType /* C++ btVector3 []& */ ;
    auto set_m_bounds(GameBindings::uint_expr, GameBindings::Bullet::btVector3) -> GameBindings::void_expr;
    ...
    auto get_m_bounds(GameBindings::uint_expr) -> MissingType /* C++ btVector3 [] */ ;
