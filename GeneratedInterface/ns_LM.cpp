...
auto TypeMirror::get_instance_size() -> MissingType /* C++ unsigned long long */ 
{
    ::LM::ExprPtr args[] = {  }; 
...
auto MarkableObjGraph::number_of_children() -> MissingType /* C++ unsigned long long */ 
{
    ::LM::ExprPtr args[] = {  }; 
...
auto MarkableObjGraph::number_of_parents() -> MissingType /* C++ unsigned long long */ 
{
    ::LM::ExprPtr args[] = {  }; 
