...
};struct NativeArray_of_double
{
    ...
    auto tmp(GameBindings::uint_expr) -> GameBindings::NativeArray_of_double;
    auto tmp(GameBindings::uint_expr, GameBindings::double_expr) -> GameBindings::NativeArray_of_double;
    auto lm_new(GameBindings::uint_expr) -> GameBindings::NativeArray_of_double;
    auto lm_new(GameBindings::uint_expr, GameBindings::double_expr) -> GameBindings::NativeArray_of_double;
    auto lm_delete() -> GameBindings::void_expr;
...
};struct NativeArray_of_float
{
    ...
    auto tmp(GameBindings::uint_expr) -> GameBindings::NativeArray_of_float;
    auto tmp(GameBindings::uint_expr, GameBindings::float_expr) -> GameBindings::NativeArray_of_float;
    auto lm_new(GameBindings::uint_expr) -> GameBindings::NativeArray_of_float;
    auto lm_new(GameBindings::uint_expr, GameBindings::float_expr) -> GameBindings::NativeArray_of_float;
    auto lm_delete() -> GameBindings::void_expr;
